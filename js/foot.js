...
$(document).ready(function(e){
  $('.copyright').html('©2022 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By Rhyme');
})
...
$('.framework-info').html('Rhyme的博客已经安全运行<span id="span_dt_dt" style="color: #fff;"></span>');
